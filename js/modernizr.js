// Definición de la función autoejecutable que crea el objeto Modernizr
!function(e,n,t){
    // Función para verificar el tipo de una variable
    function r(e,n){return typeof e===n}

    // Función principal que agrega tests al objeto Modernizr
    function o(){
        var e,n,t,o,a,s,i;
        for(var c in x)
            if(x.hasOwnProperty(c)){
                ...
                // Iteración sobre los nombres de los tests
    ...
    // Función para añadir clases al elemento HTML
    function a(e){
    ...
    // Función para buscar una subcadena en un string
    function d(e,n){return!!~(""+e).indexOf(n)}

    // Función para crear funciones con un contexto específico
    function f(e,n){return function(){return e.apply(n,arguments)}}

    // Función para obtener una propiedad CSS con su prefijo
    function u(e,n,t){var o;for(var a in e)if(e[a]in n)return t===!1?e[a]:(o=n[e[a]],r(o,"function")?f(o,t||n):o);return!1}

    // Función para añadir el prefijo CSS según el navegador
    function p(e){return e.replace(/([A-Z])/g,function(e,n){return"-"+n.toLowerCase()}).replace(/^ms-/,"-ms-")}

    // Función para probar si se soporta una propiedad CSS
    function m(n,r){
        var o=n.length;
        ...
        if("CSSSupportsRule"in e){
            ...
            return a=a.join(" or "),l("@supports ("+a+") { #modernizr { position: absolute; } }",function(e){return"absolute"==getComputedStyle(e,null).position})
        }
        return t
    }

    // Función para probar si se soporta una propiedad CSS con prefijo
    function v(e,n,o,a){
        ...
        for(p=e.length,u=0;p>u;u++)
            if(v=e[u],g=j.style[v],d(v,"-")&&(v=i(v)),j.style[v]!==t){
                ...
                try{j.style[v]=o}catch(h){}
                if(j.style[v]!=g)return c(),"pfx"==n?v:!0
            }
        return c(),!1
    }

    // Función para probar si se soporta una propiedad CSS con todos los prefijos
